 ...
 *
 * @link http://smarty.php.net/manual/en/language.function.html.image.php
 *       {html_image}
...
function smarty_function_html_image ($params, $template)
{
    ...
    foreach ($params as $_key => $_val) {
        switch ($_key) {
            ...
            if (empty($file)) {
                trigger_error("html_image: missing 'file' parameter", 
                        E_USER_NOTICE);
                return;
            }
            ...
            return $prefix . '<img src="' . $path_prefix . $file . '" alt="' .
