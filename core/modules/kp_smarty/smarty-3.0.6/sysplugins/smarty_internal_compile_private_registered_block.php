...
class Smarty_Internal_Compile_Private_Registered_Block extends Smarty_Internal_CompileBase
{
    ...
    public function compile ($args, $compiler, $parameter, $tag)
    {
        ...
        if (strlen($tag) < 6 || substr($tag, - 5) != 'close') {
            ...
            $this->compiler->nocache = ! $compiler->smarty->registered_plugins[Smarty::PLUGIN_BLOCK][$tag][1] |
                     $this->compiler->nocache | $this->compiler->tag_nocache;
                    ...
                    list ($_params, $this->compiler->nocache) = $this->_close_tag(
                            $base_tag);
                    ...
                    if (! isset($parameter['modifier_list'])) {
                        ...
                        $mod_post = 'echo ' .
                            ...
                            if (! is_array($function)) {
                                $output = "<?php \$_block_content = ob_get_clean(); \$_block_repeat=false;" .
                                         $mod_pre .
                                         " echo {$function}({$_params}, \$_block_content, \$_smarty_tpl, \$_block_repeat);" .
                                         $mod_post .
