...
class Smarty_Internal_Register
{
     ...
     * @param $cache_attr array
     *            caching attributes if any
     */
    
    public function registerPlugin ($type, $tag, $callback, $cacheable = true, 
            $cache_attr = null)
    {
        ...
        elseif (! is_callable($callback)) {
            ...
            $this->smarty->registered_plugins[$type][$tag] = array($callback, 
                    (bool) $cacheable);
            if (isset($cache_attr) &&
                     in_array($type, 
                            array(Smarty::PLUGIN_BLOCK, Smarty::PLUGIN_FUNCTION))) {
            ...
            {
                $this->smarty->registered_resources[$type] = array($callback, 
                        false);
            }
             ...
             * @param $ mixed
             *            null | array $allowed list of allowed methods (empty =
             *            all)
             * @param $smarty_args boolean
             *            smarty argument format, else traditional
             * @param $ mixed
             *            null | array $block_functs list of methods that are
             *            block format
             */
            function registerObject ($object_name, $object_impl, 
                    $allowed = array(), $smarty_args = true, $block_methods = array())
            {
                ...
                $this->smarty->registered_objects[$object_name] = array(
                        $object_impl, (array) $allowed, (boolean) $smarty_args, 
                        (array) $block_methods);
            }
             ...
             *            string | array $plugin class/methode name
             */
             ...
             *
             * @param $callback mixed
             *            string | array class/method name
             */
