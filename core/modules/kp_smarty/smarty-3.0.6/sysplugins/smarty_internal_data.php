...
class Smarty_Internal_Data
{
     ...
     *
     * @param $ array
     *            |string $tpl_var the template variable name(s)
     * @param $value mixed
     *            the value to assign
    ...
    public function assign_by_ref ($tpl_var, &$value)
    {
        if ($this->smarty->deprecation_notices)
            trigger_error(
                    "function call 'assign_by_ref' is unknown or deprecated, use 'assignByRef'", 
                    E_USER_NOTICE);
            ...
            foreach ($tpl_var as $_key => $_val) {
                if ($_key != '') {
                    if (! isset($this->tpl_vars[$_key])) {
                        $tpl_var_inst = $this->getVariable($_key, null, true, 
                                false);
                    ...
                    if (! (is_array($this->tpl_vars[$_key]->value) ||
                             $this->tpl_vars[$_key]->value instanceof ArrayAccess)) {
                    ...
                    if ($tpl_var != '' && isset($value)) {
                        if (! isset($this->tpl_vars[$tpl_var])) {
                            $tpl_var_inst = $this->getVariable($tpl_var, null, 
                                    true, false);
                            if ($tpl_var_inst instanceof Undefined_Smarty_Variable) {
                        ...
                        if (! (is_array($this->tpl_vars[$tpl_var]->value) ||
                                 $this->tpl_vars[$tpl_var]->value instanceof ArrayAccess)) {
                                    settype($this->tpl_vars[$tpl_var]->value, 
                                            'array');
                                }
                     ...
                     *            flag if array elements shall be merged
                     */
                    public function appendByRef ($tpl_var, &$value, 
                            $merge = false)
                    {
                        if ($tpl_var != '' && isset($value)) {
                            if (! isset($this->tpl_vars[$tpl_var])) {
                     ...
                     *            flag if array elements shall be merged
                     */
                    public function append_by_ref ($tpl_var, &$value, 
                            $merge = false)
                    {
                        if ($this->smarty->deprecation_notices)
                            trigger_error(
                                    "function call 'append_by_ref' is unknown or deprecated, use 'appendByRef'", 
                                    E_USER_NOTICE);
                     ...
                     */
                    function getTemplateVars ($varname = null, $_ptr = null, 
                            $search_parents = true)
                    {
                        if (isset($varname)) {
                            $_var = $this->getVariable($varname, $_ptr, 
                            ...
                            /**
                             * load a config file, optionally load just selected
                             * sections
                             *
                             * @param $config_file string
                             *            filename
                             * @param $sections mixed
                             *            array of section names, single section
                             *            or null
                             */
                            ...
                            {
                                // load Config class
                                $config = new Smarty_Internal_Config(
                                        $config_file, $this->smarty, $this);
                             ...
                             */
                            public function getVariable ($_variable, 
                                    $_ptr = null, $search_parents = true, 
                                    $error_enable = true)
                            {
                                if ($_ptr === null) {
                                    $_ptr = $this;
                             ...
                             * @param $varname string
                             *            variable name or null
                             * @return string variable value or or array of
                             *         variables
                             */
                                    ...
                                    $search_parents = true)
                            {
                                ...
                                while ($_ptr !== null) {
                                    if (isset($varname)) {
                                        ...
                                        $var_array = array_merge(
                                                $_ptr->config_vars, $var_array);
                                    }
                                    // not found, try at parent
                                    if ($search_parents) {
                                        $_ptr = $_ptr->parent;
                         ...
                         *
                         * The Smarty data object will hold Smarty variables in
                         * the current scope
                         *
                         * @param $parent object
                         *            tpl_vars next higher level of Smarty
                         *            variables
                         */
                        class Smarty_Data extends Smarty_Internal_Data
                        {
                                    ...
                                    $smarty = null)
                            {
                                ...
                                elseif ($_parent != null) {
                                    throw new SmartyException(
                                            "Wrong type for template variables");
                                }
                            }
                        }
                        ...
                        class Smarty_Variable
                        {
                             ...
                             *            the value to assign
                             * @param $nocache boolean
                             *            if true any output of this variable
                             *            will be not cached
                             * @param $scope boolean
                             *            the scope the variable will have
                             *            (local,parent or root)
                             */
                            public function __construct ($value = null, 
                                    $nocache = false, $scope = Smarty::SCOPE_LOCAL)
                            {
                                $this->value = $value;
                         ...
                         *
                         * This class defines an object for undefined variable
                         * handling
                         */
