...
class Smarty_Internal_Resource_Registered
{
    ...
    public function getTemplateTimestamp ($_template)
    {
        ...
        call_user_func_array(
                $this->smarty->registered_resources[$_template->resource_type][0][1], 
     ...
     * @return int timestamp
     */
    public function getTemplateTimestampTypeName ($_resource_type, 
            $_resource_name)
    {
        // return timestamp
        $time_stamp = false;
        call_user_func_array(
                $this->smarty->registered_resources[$_resource_type][0][1], 
    ...
    public function getTemplateSource ($_template)
    {
        ...
        return call_user_func_array(
                $this->smarty->registered_resources[$_template->resource_type][0][0], 
                array($_template->resource_name, &$_template->template_source, 
                        $this->smarty));
    }
    ...
    public function getCompiledFilepath ($_template)
    {
        ...
        return $_compile_dir . $_filepath . '.' . $_template->resource_type . '.' .
                 basename($_template->resource_name) . $_cache . '.php';
            }
        }
