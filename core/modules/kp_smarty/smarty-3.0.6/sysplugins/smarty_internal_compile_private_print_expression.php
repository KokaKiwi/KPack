...
class Smarty_Internal_Compile_Private_Print_Expression extends Smarty_Internal_CompileBase
{
    ...
    public function compile ($args, $compiler, $parameter)
    {
        ...
        if (isset($_attr['assign'])) {
            ...
            if (! $_attr['nofilter'] &&
                     isset(
                            $this->compiler->smarty->registered_filters['variable'])) {
                    ...
                    if (! $_attr['nofilter'] &&
                             ! empty($this->compiler->smarty->default_modifiers)) {
                                ...
                                $output = $this->compiler->compileTag(
                                        'private_modifier', array(), 
                                        array('modifierlist' => $modifierlist, 
                                                'value' => $output));
                            }
