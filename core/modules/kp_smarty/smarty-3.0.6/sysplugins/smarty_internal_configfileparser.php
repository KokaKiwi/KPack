...
class TPC_yyStackEntry
{
    ...
    public $minor; /*
                    * The user-supplied minor token value. This * is the value
                    * of the token
                    */
}
;
                                       ...
                                       // "smarty_internal_configfileparser.php"
{
    ...
    private static function parse_single_quoted_string ($qstr)
    {
        ...
        $ss = preg_split('/(\\\\.)/', $escaped_string, - 1, 
    ...
    private function set_var (Array $var, Array &$target_array)
    {
        ...
        if ($this->smarty->config_overwrite ||
            ...
            private function add_section_vars ($section_name, Array $vars)
            {
                ...
                foreach ($vars as $var) {
                    $this->set_var($var, 
                            $this->compiler->config_data['sections'][$section_name]);
                }
            }
            // ine 175 "smarty_internal_configfileparser.php"
 ...
 /*     0 */    40, 36, 33, 37, 52, 52, 52, 32, 
                    35, 40,
 /*    10 */    40, 52, 52, 52, 52, 52, 52, 52, 50, 51,
 /*    20 */    49, 44, 41, 
                    39, 38, 34, 42, 43, 47, 46,
 /*    30 */    45, 48);
            ...
            public $yyTokenName = array('$', 'OPENB', 'SECTION', 'CLOSEB', 
                    'DOT', 'ID', 'EQUAL', 'FLOAT', 'INT', 'BOOL', 
                    'SINGLE_QUOTED_STRING', 'DOUBLE_QUOTED_STRING', 
                    'TRIPPLE_DOUBLE_QUOTED_STRING', 'NAKED_STRING', 'NEWLINE', 
                    'COMMENTSTART', 'error', 'start', 'global_vars', 'sections', 
                    'var_list', 'section', 'newline', 'var', 'value');
 ...
 /*  19 */ "newline ::= COMMENTSTART NAKED_STRING NEWLINE");
            ...
            static function yy_destructor ($yymajor, $yypminor)
            {
                switch ($yymajor) {
                    default:
                        break; /*
                                          * If no destructor action specified:
                                          * do nothing
                                          */
                }
            }
            ...
            function yy_pop_parser_stack ()
            {
                ...
                if (self::$yyTraceFILE && $this->yyidx >= 0) {
                    fwrite(self::$yyTraceFILE, 
                            self::$yyTracePrompt . 'Popping ' .
                                     $this->yyTokenName[$yytos->major] . "\n");
                }
                $yymajor = $yytos->major;
                             ...
                             $yyact < self::YYNSTATE + self::YYNRULE) {
                                ...
                                do {
                                    if ($done ++ == 100) {
                                        $this->yyidx = $yyidx;
                                        $this->yystack = $stack;
                                        // too much recursion prevents proper
                                        // detection
                                        // so give up
                                    ...
                                    elseif ($nextstate ==
                                             self::YYNSTATE + self::YYNRULE + 1) {
                                                $this->yyidx = $yyidx;
                                                $this->yystack = $stack;
                                                // the last token was just
                                                // ignored, we can't accept
                                                // by ignoring input, this is in
                                                // essence ignoring a
                                                // syntax error!
                                                return array_unique($expected);
                                            }
                                    ...
                                    {
                                        if ($token === 0) {
                                            return true; // 0 is not part of
                                                         // this
                                        }
                                        $state = $this->yystack[$this->yyidx]->stateno;
                                        if (in_array($token, 
                                                self::$yyExpectedTokens[$state], 
                                                true)) {
                                            return true;
                                        }
                                        $stack = $this->yystack;
                                        $yyidx = $this->yyidx;
                                        do {
                                            $yyact = $this->yy_find_shift_action(
                                                    $token);
                                            if ($yyact >= self::YYNSTATE &&
                                                     $yyact <
                                                     self::YYNSTATE +
                                                                        ...
                                                                        if ($i ===
                                                                                ...
                                                                                if ($iLookAhead ==
                                                                                        ...
                                                                                        if ($i <
                                                                                                 ...
                                                                                                 $iLookAhead) {
                                                                                                    if (count(
                                                                                                     ...
                                                                                                     count(
                                                                                                            self::$yyFallback) &&
                                                                                                     ($iFallback = self::$yyFallback[$iLookAhead]) !=
                                                                                                     0) {
                                                                                                        if (self::$yyTraceFILE) {
                                                                                                            fwrite(
                                                                                                                    self::$yyTraceFILE, 
                                                                                                ...
                                                                                                return $this->yy_find_shift_action(
                                                                                                        $iFallback);
                                                                                            }
                                                                                            return self::$yy_default[$stateno];
                                                                                        }
                                                                                            ...
                                                                                            $iLookAhead)
                                                                                    {
                                                                                        ...
                                                                                        if (! isset(
                                                                                                self::$yy_reduce_ofst[$stateno])) {
                                                                                            return self::$yy_default[$stateno];
                                                                                        }
                                                                                        $i = self::$yy_reduce_ofst[$stateno];
                                                                                        if ($i ==
                                                                                                 self::YY_REDUCE_USE_DFLT) {
                                                                                                    return self::$yy_default[$stateno];
                                                                                                }
                                                                                                if ($iLookAhead ==
                                                                                                         self::YYNOCODE) {
                                                                                            ...
                                                                                            function yy_r10 ()
                                                                                            {
                                                                                                $this->_retvalue = (float) $this->yystack[$this->yyidx +
                                                                                                         0]->minor;
                                                                                                    }
                                                                                                    // ine
                                                                                                    // 677
                                                                                                    ...
                                                                                                    function yy_r11 ()
                                                                                                    {
                                                                                                        $this->_retvalue = (int) $this->yystack[$this->yyidx +
                                                                                                                 0]->minor;
                                                                                                            }
                                                                                                            // ine
                                                                                                            // 680
                                                                                                            ...
                                                                                                            function yy_r12 ()
                                                                                                            {
                                                                                                                $this->_retvalue = $this->parse_bool(
                                                                                                                        $this->yystack[$this->yyidx +
                                                                                                                                 0]->minor);
                                                                                                            }
                                                                                                            // ine
                                                                                                            ...
                                                                                                            function yy_r13 ()
                                                                                                            {
                                                                                                                $this->_retvalue = self::parse_single_quoted_string(
                                                                                                                        $this->yystack[$this->yyidx +
                                                                                                                                 0]->minor);
                                                                                                            }
                                                                                                            // ine
                                                                                                            ...
                                                                                                            function yy_r14 ()
                                                                                                            {
                                                                                                                $this->_retvalue = self::parse_double_quoted_string(
                                                                                                                        $this->yystack[$this->yyidx +
                                                                                                                                 0]->minor);
                                                                                                            }
                                                                                                            // ine
                                                                                                            ...
                                                                                                            function yy_r15 ()
                                                                                                            {
                                                                                                                $this->_retvalue = self::parse_tripple_double_quoted_string(
                                                                                                                        $this->yystack[$this->yyidx +
                                                                                                                                 0]->minor);
                                                                                                            }
                                                                                                            // ine
