...
class Smarty_Internal_Compile_For extends Smarty_Internal_CompileBase
{
     ...
     * For general loops
     *
     * The parser is gereration different sets of attribute by which this
     * compiler can
    ...
    public function compile ($args, $compiler, $parameter)
    {
        ...
        $this->_open_tag('for', 
                array('for', $this->compiler->nocache, $local_vars));
        ...
        class Smarty_Internal_Compile_Forelse extends Smarty_Internal_CompileBase
        {
            ...
            public function compile ($args, $compiler, $parameter)
            {
                ...
                list ($_open_tag, $nocache, $local_vars) = $this->_close_tag(
                        array('for'));
                $this->_open_tag('forelse', 
                        array('forelse', $nocache, $local_vars));
                return "<?php }} else { ?>";
            }
        }
        ...
        class Smarty_Internal_Compile_Forclose extends Smarty_Internal_CompileBase
        {
            ...
            public function compile ($args, $compiler, $parameter)
            {
                ...
                list ($_open_tag, $this->compiler->nocache, $local_vars) = $this->_close_tag(
                        array('for', 'forelse'));
