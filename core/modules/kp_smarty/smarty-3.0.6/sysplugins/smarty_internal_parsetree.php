...
class _smarty_tag extends _smarty_parsetree
{
    ...
    public function assign_to_var ()
    {
        ...
        $this->parser->compiler->prefix_code[] = sprintf(
                '<?php ob_start();?>%s<?php %s=ob_get_clean();?>', $this->data, 
                $var);
        return $var;
    }
}
...
class _smarty_doublequoted extends _smarty_parsetree
{
    ...
    function __construct ($parser, _smarty_parsetree $subtree)
    {
        ...
        if ($subtree instanceof _smarty_tag) {
            $this->parser->block_nesting_level = count(
                    $this->parser->compiler->_tag_stack);
        }
    }
    ...
    function append_subtree (_smarty_parsetree $subtree)
    {
        ...
        if ($last_subtree >= 0 &&
                 $this->subtrees[$last_subtree] instanceof _smarty_tag &&
                 $this->subtrees[$last_subtree]->saved_block_nesting <
                 $this->parser->block_nesting_level) {
                    if ($subtree instanceof _smarty_code) {
                        $this->subtrees[$last_subtree]->data .= '<?php echo ' .
                         $subtree->data . ';?>';
            }
