...
class Smarty_Internal_Compile_Private_Modifier extends Smarty_Internal_CompileBase
{
    ...
    public function compile ($args, $compiler, $parameter)
    {
        ...
        foreach ($parameter['modifierlist'] as $single_modifier) {
            ...
            if (isset(
                    $compiler->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER][$modifier])) {
                ...
                if (! is_array($function)) {
                    ...
                    if (is_object($function[0])) {
                        ...
                        if ($compiler->smarty->loadPlugin(
                            ...
                            if ($function = $this->compiler->getPlugin(
                                ...
                                if (is_callable($modifier)) {
                                    ...
                                    if (! is_object(
                                            $this->smarty->security_policy) ||
                                             $this->smarty->security_policy->isTrustedModifier(
                                                    $modifier, $this->compiler)) {
