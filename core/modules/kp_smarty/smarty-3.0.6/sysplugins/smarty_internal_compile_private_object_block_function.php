...
class Smarty_Internal_Compile_Private_Object_Block_Function extends Smarty_Internal_CompileBase
{
    ...
    public function compile ($args, $compiler, $parameter, $tag, $methode)
    {
        ...
        if (strlen($tag) < 5 || substr($tag, - 5) != 'close') {
            ...
            $this->_open_tag($tag . '->' . $methode, 
                    array($_params, $this->compiler->nocache));
                    ...
                    if (! isset($parameter['modifier_list'])) {
                        ...
                        $mod_post = 'echo ' .
                            ...
                            $output = "<?php \$_block_content = ob_get_contents(); ob_end_clean(); \$_block_repeat=false;" .
                                     $mod_pre .
                                     " echo \$_smarty_tpl->smarty->registered_objects['{$base_tag}'][0]->{$methode}({$_params}, \$_block_content, \$_smarty_tpl, \$_block_repeat); " .
                                     $mod_post .
